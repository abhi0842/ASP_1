...
export const GuidedModal = () => {
  ...
  const updatePosition = () => {
    ...
    if (arrowDir === styles.arrowLeft || arrowDir === styles.arrowRight) {
      aStyle = {
        top: Math.max(15, Math.min(targetRelCenterY - top, modalHeight - 15)),
      };
    } else if (arrowDir === styles.arrowTop || arrowDir === styles.arrowBottom) {
      aStyle = {
        left: Math.max(15, Math.min(targetRelCenterX - left, modalWidth - 15)),
      };
    }
  ...
  return (
    ...
    >
      <div className={styles.modal}>
        ...
        <button className={styles.closeIcon} onClick={handleSkip} aria-label="Close">
          ×
        </button>
        ...
        <div className={styles.footer}>
          {isChoice ? (
            <div className={styles.buttonGroup}>
              <button className={styles.nextButton} onClick={handleYes}>
                Yes, show me
              </button>
            ...
            <div className={styles.buttonGroup}>
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                ...
                {step < steps.length - 1 ? (
                  ...
                  <button className={styles.nextButton} onClick={handleSkip}>
                    Finish
                  </button>
                )}
              </div>
